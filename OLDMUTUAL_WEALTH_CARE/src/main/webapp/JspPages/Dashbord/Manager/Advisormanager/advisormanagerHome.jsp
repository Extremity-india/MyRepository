<%@page import="com.app.extremity.model.AdvisorManager"%>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/Resources/DashbordResources/font-awesome">
<script
	src="${pageContext.request.contextPath}/Resources/DashbordResources/js/advisorManager.js"></script>
...
<body>
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div class="navbar-header">
				...
				<a href="advisormanagerHome.jsp" id="branding"> <img
					...
					<small class="description">Insurance</small></a> <a
					class="navbar-brand hidden" href="advisormanagerHome.jsp"><img
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="glyphicon glyphicon-user"
								style="color: white;"></i><a onclick="userdisplay()">Display
									Users</a></li>
							<li><i class="glyphicon glyphicon-user"
								style="color: white;"></i><a onclick="assignAdvisor()">Assign
									Advisor</a></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="glyphicon glyphicon-user"
								style="color: white;"></i><a onclick="addAdvisor()">Add
									advisor</a></li>

							<li><i class="glyphicon glyphicon-user"
								style="color: white;"></i><a onclick="DisplayAdvisor()">Display
									Advisor</a></li>
	...
	<div id="right-panel" class="right-panel">
		...
		<table id="admprofile" border=1 class="table table-striped table-dark"></table>
		</div>
		
		<div id="d1" style="display: none">
			<table id='table' border=1 class="table table-striped table-dark"></table>
		</div>
		
		<div id="ulisttable" style="display: none">
			<table id='table1' border=1 class="table table-striped table-dark"></table>
		</div>
		
		<div id="asignadvisor" style="display: none">
			<table id='userdisplayinassignadvisor' border=1 class="table table-striped table-dark"></table>
		</div>
    ...
    <input type="text" id="adid" placeholder="Enter ID" name="advisorID"
					required>

	<label for="advisorName"><b>Advisor Name</b></label>
    <input type="text" id="adname" placeholder="Enter advisorName"
					name="advisorName" required>

	<label for="advisorEmail"><b>Advisor Email</b></label>
    <input type="text" id="ademail" placeholder="Enter advisorEmail"
					name="advisorEmail" required>

	<label for="advisorDOB"><b>Advisor DOB</b></label>
    <input type="date" id="DOB" placeholder="Enter DOB"
					name="advisorDOB" required>

	<label for="advisorContactno"><b>Advisor mobile</b></label>
    <input type="text" id="admob" placeholder="Enter number"
					name="advisorContactno" required>

	<label for="advisorAddress"><b>Advisor Address</b></label>
    <input type="text" id="adadd" placeholder="Enter Address"
					name="advisorAddress" required>

	<label for="advisorAddPin"><b>Address Pin code</b></label>
    <input type="text" id="adpin" placeholder="Enter advisorAddPin"
					name="advisorAddPin" required>

 	<label for="advisorArea"><b>Advisor Area</b></label>
    <input type="text" id="adarea" placeholder="Enter Area" 
					name="advisorArea" required>
   
    <label for="advisormanager"><b>Assign manager</b></label>
    <input type="text" id="admag" placeholder="Null"
					name="advisormanager" required>

 
	<label for="addvisorExperince"><b>Addvisor Experince (in years)</b></label>
    <input type="text" id="adexp" placeholder="Enter addvisor Experince"
					name="addvisorExperince" required>
    

	<label for="advisorUserName"><b>Advisor User Name</b></label>
    <input type="text" id="adun" placeholder="Enter Advisor User Name"
					name="advisorUserName" required>

    <label for="advisorPassword"><b>advisorPassword</b></label>
    <input type="text" id="adpass" placeholder="Enter Password"
					name="advisorPassword" required>
...
<div id="ediprofile" style="display: none">
			<table id="etable" class="table table-striped table-dark">
			</table>
		</div>

<!------------------------Advisor Update------------------------->
		
<div id="assignadvisor" style="display: none">
		...
		<div id="assign">
			<table id="assignadv" class="table table-striped table-dark">
			</table>
		</div>
			...
			<div class="content mt-3">
				...
				<div class="col-lg-3 col-md-6">
					<div class="social-box facebook">
						...
						<ul>
							<li><strong><span class="count">40</span> k</strong> <span>friends</span>
							</li>
							<li><strong><span class="count">450</span></strong> <span>feeds</span>
							</li>
						</ul>
					</div>
					<!--/social-box-->
				...
				<div class="col-lg-3 col-md-6">
					<div class="social-box twitter">
						...
						<ul>
							<li><strong><span class="count">30</span> k</strong> <span>friends</span>
							</li>
							<li><strong><span class="count">450</span></strong> <span>tweets</span>
							</li>
						</ul>
					</div>
					<!--/social-box-->
				...
				<div class="col-lg-3 col-md-6">
					<div class="social-box linkedin">
						...
						<ul>
							<li><strong><span class="count">40</span> +</strong> <span>contacts</span>
							</li>
							<li><strong><span class="count">250</span></strong> <span>feeds</span>
							</li>
						</ul>
					</div>
					<!--/social-box-->
				...
				<div class="col-lg-3 col-md-6">
					<div class="social-box google-plus">
						...
						<ul>
							<li><strong><span class="count">94</span> k</strong> <span>followers</span>
							</li>
							<li><strong><span class="count">92</span></strong> <span>circles</span>
							</li>
						</ul>
					</div>
					<!--/social-box-->
