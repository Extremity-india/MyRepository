...
<script
	src="${pageContext.request.contextPath}/Resources/DashbordResources/js/ClinentManager.js"></script>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a onclick="getusers()">show users</a></li>
